"use strict";
exports.id = "vendors-node_modules_mermaid_dist_erDiagram-9861fffd_js";
exports.ids = ["vendors-node_modules_mermaid_dist_erDiagram-9861fffd_js"];
exports.modules = {
...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! uuid */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/v5.js");
...
const addEntity = function(name, alias = void 0) {
  if (entities[name] === void 0) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new entity :", name);
  } else if (entities[name] && !entities[name].alias && alias) {
    entities[name].alias = alias;
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.info(`Add alias '${alias}' to entity '${name}'`);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Added new relationship :", rel);
};
...
const erDb = {
  Cardinality,
  Identification,
  getConfig: () => (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.x)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", conf.fontSize + "px").text(entities2[entityName].alias ?? entityName);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().er;
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing ER diagram");
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.i)(svg, height, width, conf.useMaxWidth);
...
/* harmony export */ });
/* harmony import */ var _validate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate.js */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/validate.js");
...
/* harmony export */ });
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stringify.js */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/stringify.js");
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parse.js */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/parse.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./v35.js */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/v35.js");
/* harmony import */ var _sha1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sha1.js */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/sha1.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _regex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./regex.js */ "./node_modules/mermaid/node_modules/uuid/dist/esm-node/regex.js");
...
;
//# sourceMappingURL=vendors-node_modules_mermaid_dist_erDiagram-9861fffd_js.render-page.js.map