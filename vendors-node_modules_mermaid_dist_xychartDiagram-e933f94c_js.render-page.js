"use strict";
exports.id = "vendors-node_modules_mermaid_dist_xychartDiagram-e933f94c_js";
exports.ids = ["vendors-node_modules_mermaid_dist_xychartDiagram-e933f94c_js"];
exports.modules = {
...
class TextDimensionCalculatorWithFont {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_createText_2e5e7dd3_js__WEBPACK_IMPORTED_MODULE_5__.c)(elem, 1, t);
...
class BandAxis extends BaseAxis {
  ...
  recalculateScale() {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
function getChartDefaultThemeConfig() {
  const defaultThemeVariables = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.E)();
  const config = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.F)();
  return (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.C)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
function getChartDefaultConfig() {
  const config = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.F)();
  return (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.C)(
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.B.xyChart,
    config.xyChart
  );
}
...
function textSanitizer(text) {
  const config = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.F)();
  return (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.d)(text.trim(), config);
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.t)();
...
const draw = (txt, id, _version, diagObj) => {
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Rendering xychart chart\n" + txt);
  ...
  (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.i)(svg, chartConfig.height, chartConfig.width, true);
...
;
//# sourceMappingURL=vendors-node_modules_mermaid_dist_xychartDiagram-e933f94c_js.render-page.js.map