"use strict";
exports.id = "vendors-node_modules_mermaid_dist_blockDiagram-38ab4fdb_js";
exports.ids = ["vendors-node_modules_mermaid_dist_blockDiagram-38ab4fdb_js"];
exports.modules = {
...
/* harmony import */ var _edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./edges-e0da2a9e.js */ "./node_modules/mermaid/dist/edges-e0da2a9e.js");
...
let classes = {};
const sanitizeText = (txt) => _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.e.sanitizeText(txt, config);
...
const clear = () => {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Clear called");
...
function typeStr2Type(typeStr) {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("typeStr2Type", typeStr);
  switch (typeStr) {
    case "[]":
      return "square";
    case "()":
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("we have a round");
      return "round";
    case "(())":
      return "circle";
    case ">]":
...
const db = {
  getConfig: () => (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.F)().block,
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
  getLogger,
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.k)((vertex == null ? void 0 : vertex.styles) || []);
  ...
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: padding2 ?? (((_c = (_b2 = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.F)()) == null ? void 0 : _b2.block) == null ? void 0 : _c.padding) || 0)
  };
  return node;
}
async function calculateBlockSize(elem, block, db2) {
  ...
  const nodeEl = await (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.e)(elem, node);
...
async function insertBlockPositioned(elem, block, db2) {
  ...
  const obj = db2.getBlock(node.id);
  if (obj.type !== "space") {
    await (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.e)(elem, node);
    block.intersect = node == null ? void 0 : node.intersect;
    (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.p)(node);
  }
}
  ...
  for (const edge of edges) {
    if (edge.start && edge.end) {
      ...
      if ((startBlock == null ? void 0 : startBlock.size) && (endBlock == null ? void 0 : endBlock.size)) {
        ...
        await (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.h)(
          elem,
        ...
        if (edge.label) {
          await (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.f)(elem, {
            ...edge,
            label: edge.label,
          ...
          await (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.j)(
...
const padding = ((_b = (_a = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.c)()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) || 8;
...
const getMaxChildSize = (block) => {
  ...
  for (const child of block.children) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  if (((_c = block.children) == null ? void 0 : _c.length) > 0) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("setBlockSizes abc95 maxWidth of", block.id, ":s children is ", maxWidth, maxHeight);
    for (const child of block.children) {
      if (child.size) {
        _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(
    ...
    if (width < siblingWidth) {
      ...
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Size indata abc88", block.id, "childWidth", childWidth, "maxWidth", maxWidth);
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Size indata abc88", block.id, "childHeight", childHeight, "maxHeight", maxHeight);
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Size indata abc88 xSize", xSize, "padding", padding);
      for (const child of block.children) {
        if (child.size) {
    ...
    if (width < (((_e = block == null ? void 0 : block.size) == null ? void 0 : _e.width) || 0)) {
      ...
      if (num > 0) {
        ...
        _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("abc95 (growing to fit) width", block.id, width, (_g = block.size) == null ? void 0 : _g.width, childWidth);
        for (const child of block.children) {
          if (child.size) {
            child.size.width = childWidth;
          }
...
function layoutBlocks(block, db2) {
  ...
  const columns = block.columns || -1;
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("layoutBlocks columns abc95", block.id, "=>", columns, block);
  ...
  block.children.length > 0) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("widthOfChildren 88", widthOfChildren, "posX");
    let columnPos = 0;
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("abc91 block?.size?.x", block.id, (_f = block == null ? void 0 : block.size) == null ? void 0 : _f.x);
    ...
    for (const child of block.children) {
      ...
      if (py != rowPos) {
        ...
        _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("New row in layout for block", block.id, " and child ", child.id, rowPos);
      }
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(
      ...
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("abc88 columnsPos", child, columnPos);
    }
  }
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(
...
function layout(db2) {
  ...
  layoutBlocks(root);
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("getBlocks", JSON.stringify(root, null, 2));
...
const draw = async function(text, id, _version, diagObj) {
  const { securityLevel, block: conf } = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.F)();
  ...
  (0,_edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_10__.a)(svg, markers, diagObj.type, id);
  ...
  if (bounds) {
    ...
    (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.i)(svg, height, width, !!useMaxWidth);
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Here Bounds", bounds, bounds2);
    svg.attr(
      "viewBox",
...
;
//# sourceMappingURL=vendors-node_modules_mermaid_dist_blockDiagram-38ab4fdb_js.render-page.js.map