"use strict";
exports.id = "vendors-node_modules_mermaid_dist_index-3862675e_js";
exports.ids = ["vendors-node_modules_mermaid_dist_index-3862675e_js"];
exports.modules = {
...
/* harmony import */ var _edges_e0da2a9e_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edges-e0da2a9e.js */ "./node_modules/mermaid/dist/edges-e0da2a9e.js");
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mermaid-b5860b54.js */ "./node_modules/mermaid/dist/mermaid-b5860b54.js");
...
/* harmony import */ var _createText_2e5e7dd3_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./createText-2e5e7dd3.js */ "./node_modules/mermaid/dist/createText-2e5e7dd3.js");
...
const adjustClustersAndEdges = (graph, depth) => {
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
  extractor(graph, 0);
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.trace(clusterDb);
};
const extractor = (graph, depth) => {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph), graph.children("D"));
  if (depth > 10) {
  ...
  for (const node of nodes) {
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
      ...
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(clusterGraph));
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
    } else {
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn(
        "Cluster ** ",
        node,
...
const recursiveRender = async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph), parentCluster);
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Graph after layout:", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph));
  let diff = 0;
...
const render = async (elem, graph, markers, diagramType, id) => {
  ...
  clear();
  clear$1();
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph)));
  adjustClustersAndEdges(graph);
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.l.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_1__.write(graph)));
  const siteConfig = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_4__.c)();
...
;
//# sourceMappingURL=vendors-node_modules_mermaid_dist_index-3862675e_js.render-page.js.map