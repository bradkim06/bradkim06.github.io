"use strict";
exports.id = "vendors-node_modules_mermaid_dist_requirementDiagram-deff3bca_js";
exports.ids = ["vendors-node_modules_mermaid_dist_requirementDiagram-deff3bca_js"];
exports.modules = {
...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const db = {
  ...
  VerifyType,
  Relationships,
  getConfig: () => (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__.c)().requirement;
...
;
//# sourceMappingURL=vendors-node_modules_mermaid_dist_requirementDiagram-deff3bca_js.render-page.js.map